...
user.setTengu(tengu)
user.pushSkill(food)
user.pushSkill(white)
user.pushSkill(warrior)
user.pushPlaceSkill(domain)
user.pushPlaceSkill(v4)
...
application.pushSkill(white)
application.pushSkill(warrior)
application.pushSkill(domain)
application.pushSkill(v4)
application.pushSkill(kishin)
application.pushSkill(totem)
application.pushSkill(boss)
application.pushSkill(tengu)
